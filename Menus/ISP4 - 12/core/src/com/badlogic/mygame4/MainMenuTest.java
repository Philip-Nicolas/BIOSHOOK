...
public class MainMenuTest extends ApplicationAdapter implements Screen {
	private Stage stage;
    ...
    public void create () {
        ...
        title.setPosition(0,Gdx.graphics.getHeight()-row_height*10);
        ...
        Button button15 = new TextButton ("Instructions", mySkin);
        Button button16 = new TextButton ("Quit", mySkin);
        ...
        button16.setSize(col_width*6, row_height);
        button2.setPosition(col_width*1,Gdx.graphics.getHeight()-row_height*6);
        button15.setPosition(col_width*7, Gdx.graphics.getHeight () - row_height*6);
        button16.setPosition(col_width*3, Gdx.graphics.getHeight () - row_height*8);
        ...
        button15.addListener (new InputListener() {
            ...
            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
            	((Game)Gdx.app.getApplicationListener()).setScreen(new   
           		     InstructionsTest());
            	//outputLabel.setText("Go to Instructions"); //needs to go to dif. screen instead
                //outputLabel.setText("Pressed Text Button");
                //Game.setScreen (new Instructions ());
                return true;
            }
        });
      ...
      //trying 
        button16.addListener (new InputListener() {
        	/*@Override
            public void touchUp (InputEvent event, float x, float y, int pointer, int button) {
                outputLabel.setText("A button without text");
                //outputLabel.setText("Press a Button");
            ...
            @Override
            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
                outputLabel.setText("Quit/Exit game"); //needs to go to exit game
                //outputLabel.setText("Pressed Text Button");
                return true;
            }
        });
       ...
       /* // ImageButton
        ...
        outputLabel.setSize(Gdx.graphics.getWidth(),row_height*-1);
    ...
    @Override
    public void render () {
    	//Gdx.gl.glClearColor(204/255f, 255/255f, 255/255f, 1);
