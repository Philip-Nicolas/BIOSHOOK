 ...
 * @author phil.nic
 */
public class GameLevel1 extends ApplicationAdapter implements Disposable {
    ...
    public void create () {
        ...
        player = new Player (world, map, 1, 2, "macrophage");
        rbcs = new RBCs (world, map, 300);
        glucoseTransporters = new GlucoseTransporters (world, map, 10);
        proteins = new Proteins (world, map, 10);
        antigens = new Antigens (world, map, 30, 0.5f, "green");
        hud = new GameHUD (player);

        renderer = new HexagonalTiledMapRenderer (new TmxMapLoader ().load ("brain/brain.tmx"), 1f);
    }
